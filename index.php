...
<table width="1050px" align="center"  border="1">
  <tbody>
    <tr>
      <th height="39" colspan="2" style="background-color:red"><div style="text-align:left;color:#FFFFFF"><b><font size="+3"><a href="index.php" style="text-decoration:none ; color:#FFFFFF"><?php echo $colgdisp['colgname'];?></a></font></b><marquee direction="left" height="100%">
...
<li><img src="data1/images/vvce1.jpg" alt="Multispeciality College Campus" title="Multispeciality College Campus" id="wows1_0"/></li>
<!--<li><img src="data1/images/vvce2.jpg" alt="International Accredition" title="International Accredition" id="wows1_1"/ ></li>
...
<li><img src="data1/images/url.jpg" alt="Best Of Class Infrastructure" title="Best Of Class Infrastructure" id="wows1_3"/></li>-->
    ...
    <tr>
      <td height="38" colspan="2" style="background-color:red">
	...
	?>
      ...
      <td width="343" style="background-color:red">
      <center><font size="+2"><b style="color:#191B7E"><div style="background-color:red">College Updates</div><br></b></font></center>
    ...
    <tr>
      <td height="25" colspan="2" style="background-color:red"><center><b>&copy; <?php echo $footerdisp['footerinfo']; ?></b></center>
