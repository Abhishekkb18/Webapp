...
<table width="1050px" align="center"  border="1">
  <tbody>
    <tr>
      <th height="39" colspan="2" style="background-color:red"><div style="text-align:left;color:#FFFFFF"><b><font size="+3"><a href="index.php" style="text-decoration:none ; color:#FFFFFF">Vidyavardhaka college of engineering</a></font></b><marquee direction="left" height="100%">
				You have to pay the fees before due date of 4th Jan</marquee></div></th>
    </tr>
    <tr>
...
<span class="wsl"></span>
  ...
  <a href="logout.php" style="text-decoration:none;margin-left:150px;"><input type="submit" value="Logout" name="logout"></a></td>
    ...
    <tr>
      <td height="25" colspan="2" style="background-color:red"><center><b>&copy; 2018 by UserName | Managed by VVCE</b></center></td>
    </tr>
  </tbody>
</table>
</html>